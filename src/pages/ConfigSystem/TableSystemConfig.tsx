...
//redux
import { reset, setConfig, configSelector } from "../../slices/ConfigSystemSlice";

//types
import { TConfigSystem } from "../../Interfaces/IConfigSystem";

const TableSystemConfig = () => {
  ...
  const handleEditForm = (e: MouseEvent<HTMLButtonElement>, config: TConfigSystem) => {
    e.preventDefault();
    setIsEditing(true);
    setEditForm({ ...config });
  };
...
export default TableSystemConfig;
